...
const APP_LOCALES: Array<{ value: AppLocale; label: string }> = [
      ...
      <main className="min-w-0 flex-1">
        <div
          ...
          <div className="flex items-center gap-2">
            <Select
              value={locale}
              onValueChange={(value: string) => switchLocale(value as AppLocale)}>
            ...
            <Button
              ...
              aria-label="GitHub">
              <a
                href="https://github.com/caigh1012/fullstack-nextjs-agent"
                target="_blank"
                rel="noreferrer">
                <svg
